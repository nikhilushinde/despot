...
static const float all_obstacle_center_x_g[NUM_OBSTACLES_g] = {41, 101, 171}; // the x value of each obstacle
static const float all_obstacle_center_y_g[NUM_OBSTACLES_g] = {170, 150, 180}; // the initial y value of each obstacle
